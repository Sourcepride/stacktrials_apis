...
async def create_chat(
    ...
    return await ChatService.create_chat(session, current_user, data)
...
async def accept_invite(
    ...
    return await ChatService.accept_invite(session, current_user, token)
...
async def join_public_chat(
    ...
    return await ChatService.join_public_group(
...
async def add_directly(
    ...
    return await ChatService.add_directly(session, current_user, user_id, course_id)
